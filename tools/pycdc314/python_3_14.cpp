...
BEGIN_MAP(3, 14)
    ...
    MAP_OP(128, RESUME_A)
    MAP_OP(234, INSTRUMENTED_END_FOR)
    MAP_OP(235, INSTRUMENTED_POP_ITER)
    MAP_OP(236, INSTRUMENTED_END_SEND)
    MAP_OP(237, INSTRUMENTED_FOR_ITER_A)
    MAP_OP(238, INSTRUMENTED_INSTRUCTION)
    MAP_OP(239, INSTRUMENTED_JUMP_FORWARD_A)
    MAP_OP(240, INSTRUMENTED_NOT_TAKEN)
    ...
    MAP_OP(246, INSTRUMENTED_RETURN_VALUE)
    ...
    MAP_OP(252, INSTRUMENTED_CALL_FUNCTION_EX)
    MAP_OP(253, INSTRUMENTED_JUMP_BACKWARD_A)
    MAP_OP(254, INSTRUMENTED_LINE)
END_MAP()
